...
namespace Component {
    ...
    Aggressive_Targeting::Aggressive_Targeting(Mob* mob, Player* player, MobPtrVec* mobs, unsigned maxDist)
        : Component_Base(mob), m_mobVec(mobs), m_maxDist(maxDist), m_player(player) {}
