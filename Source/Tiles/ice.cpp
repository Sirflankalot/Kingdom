...
namespace Tiles {
    ...
    Ice::Ice(Game& game, const sf::Vector2i& pos, Tile_Map* tileMap, const Ecosystem ecosystem, const sf::Color& light)
        : Tile(game, pos, ecosystem, light), m_tileMap(tileMap), m_game(&game) {
